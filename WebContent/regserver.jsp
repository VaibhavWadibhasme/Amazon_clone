...
<%
	...
	try {
		...
		if (!rs.next()) {
			...
			try {
				String sql1 = "insert into signup_data (name,mobile,email,password,otp,status)values('" + name
						+ "','" + mobile + "','" + email + "','" + password + "','" + otp + "','0')";
			...
			session.setAttribute("sesreg", "Email Already Exits");
