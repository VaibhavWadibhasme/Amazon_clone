...
function firstDropDown() {
    ...
    if(firstDropdownOpen) {
        document.querySelector("#firstDropDown i").setAttribute("class", "fa fa-caret-up");
        ...
        document.querySelector("#firstDropDown i").setAttribute("class", "fa fa-caret-down");
...
function secondDropDown() {
    ...
    if(secondDropDownOpen) {
        document.querySelector("#secondDropDown i").setAttribute("class", "fa fa-caret-up");
        ...
        document.querySelector("#secondDropDown i").setAttribute("class", "fa fa-caret-down");
