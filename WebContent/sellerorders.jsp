...
<link rel="stylesheet" href="css/order_dashstyle.css" />
...
<body>
				...
				<div id="nav-belt">
					...
					<div id="nav-main">
						<div class="nav-right">
							...
							<a class="nav-a" href="#"><span>Return </span> &amp; Orders </a>
								...
								<div id="main-container">
									...
									<a href="#"><div class="sidenavContent">Home</div></a> <a
										...
										href="#"><div class="sidenavContent" id="myproductid">Your
											...
											id="addnewproductid">Add New Product</div></a> <a href="sellerlogout.jsp"><div
											class="sidenavContent">Log Out</div></a>
	...
	<%
		try {
			...
			String sql = "select * from order_placed where seller='" + seslogseller + "'";
			PreparedStatement pst = con.prepareStatement(sql);
			ResultSet rs = pst.executeQuery();
			while (rs.next()) {
				int pid = (int) rs.getInt("product_id");
				int qyt = (int) rs.getInt("qyt");
				String buyer = rs.getString("buyer");
				try {
					String sql1 = "select * from product_details where seller_name='" + seslogseller + "' and id='"+pid+"'";
					PreparedStatement pst1 = con.prepareStatement(sql1);
					ResultSet rs1 = pst1.executeQuery();
					while (rs1.next()) {
						String pname = rs1.getString("product_name");
						double pprice = rs1.getDouble("product_price");
						String pimg = rs1.getString("image1");
	%>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col col-lg-6 col-md-6 col-sm-6 col-xs-6">
					...
					<h4><b>QYT</b> : &nbsp;<%=qyt %></h4>
					<h4><b>Delivary address :</b></h4>
					<% 
					try{
						Class.forName("com.mysql.jdbc.Driver");
						Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/amazon", "root", "");
						String sqll = "select * from address_data where email='"+buyer+"'";
						PreparedStatement pstt = conn.prepareStatement(sqll);
						ResultSet rss = pstt.executeQuery();
						while (rss.next()) {
							String fname=rss.getString("fullname");
							String houseno=rss.getString("houseno");
							String area=rss.getString("area");
							String landmark=rss.getString("landmark");
							String city=rss.getString("city");
							String state=rss.getString("state");
							String pincode=rss.getString("pincode");
							%>
							<p><%=fname %></p>
							<p><%=houseno %> <%=area %></p>
							<p><%=landmark %></p>
